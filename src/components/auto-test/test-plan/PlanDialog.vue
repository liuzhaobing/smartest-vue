      ...
      <section>
        ...
        >
          <div v-if="active === 0">
            ...
            <div v-if="addPlanForm.task_type === 'kg'">
          ...
          <div v-if="active === 1">
            <div>
              <el-form-item label="数据源类型" prop="task_data_source_label">
                <el-select
            ...
            <div v-if="addPlanForm.task_data_source.task_data_source_label === 'source_kg'" >
            ...
            <div v-if="addPlanForm.task_data_source.task_data_source_label === 'cases_kg'" >
              <el-form-item label="用例数据" prop="cases_kg">
                <el-input v-model="addPlanForm.task_data_source.cases_kg" type="textarea" :rows="10"/>
              </el-form-item>
            </div>
            <div v-if="addPlanForm.task_data_source.task_data_source_label === 'excel_kg'">
